...
<div class="container">
    <div class="header">
        <h1>✏️ SỬA KHÁCH HÀNG</h1>
        <p>Cập nhật thông tin khách hàng</p>
        <span class="customer-id-badge">ID: #${customer.customerId}</span>
    </div>
    ...
    <div class="form-body">
        ...
        <div class="info-box">
            💡 Đang chỉnh sửa thông tin của <strong>${customer.fullName}</strong>.<br>
        ...
        <form action="${pageContext.request.contextPath}/customers" method="post">
            ...
            <div class="form-group">
                ...
                <p class="hint">⚠️ Chỉ chỉnh sửa khi cần điều chỉnh thủ công. Hệ thống tự cộng điểm khi mua vé.</p>
            </div>
